...
namespace ChinaSoftRCW.Migrations
{
    ...
    [Migration("20200708092147_add-more-options-for-dropdownlist")]
    partial class addmoreoptionsfordropdownlist
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChinaSoftRCW.Models.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ChinaSoftRCW.Models.JobState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ChinaSoftRCW.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            ProjectName = "Microsoft-Azure-Testing"
                        },
                        new
                        {
                            Id = 7,
            ...
            modelBuilder.Entity("ChinaSoftRCW.Models.Candidate", b =>
                {
                    b.HasOne("ChinaSoftRCW.Models.Gender", "Gender")
                        .WithMany("Candidates")
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ChinaSoftRCW.Models.JobState", "JobState")
                        .WithMany("Candidates")
